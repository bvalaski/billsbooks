...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-5 margin-tb mb-2">
      <div class="pull-left">
        <h2>Edit a book</h2>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-5">
        <div class="row mb-1">
          ...
          <div class="col-sm-4 col-med-6 col-lg-8">
            <div class="form-group">
              <input class="form-control" type="text" name="title" value="{{ $book->title }}" id="get_title" placeholder="Title">
            </div>
          </div>
        </div>
        <div class="row mb-1">
        ...
        <div class="row mb-1">
          ...
          <div class="col-sm-7">
            <select class="form-select" name="coauthor_id" for="get_coauth" aria-label="Co-Author">
              <option selected>Co-Author</option>
              @foreach ($coauth_list as $coauthor_label)
              <option @if ($coauthor_label->id == $book->coauth_id)
                selected="selected"
                @endif
                value="{{$coauthor_label->id}}">{{$coauthor_label->lastname.", ".$author_label->firstname}}</option>
              @endforeach
            </select>
          </div>
        </div>
        <div class="row mb-1">
          ...
          <div class="col-sm-2">
            <input class="form-control" type="integer" name="published" value="{{ $book->published }}" id="get_pub_date">
          </div>
        ...
        <div class="row mb-1">
          ...
          <div class="col-sm-4">
            <div class "form-group"><input type="number" name="isbn" value="{{ $book->isbn }}" id=get_isbn" class="form-control" placeholder="ISBN #">
            </div>
          </div>
          <label for="get_dtread" class="col-auto col-form-label"><strong>Date read:</strong></label>
          <div class="col-sm-4">
            <div class "form-group">
              <input type="date" name="date_read" value="{{ $book->date_read }}" id="get_dtread" class="form-control" placeholder="2022-01-01">
            </div>
          </div>
        </div>
        <div class="row mb-1">
          ...
          <div class="col-sm-2">
            <div class "form-group">
              <input type="integer" name="rating" value="{{ $book->rating }}" id="get_rating" class="form-control" placeholder="Rating">
            </div>
          </div>
        ...
        <div class="row mb-1">
          <div class="form-floating">
            <textarea class="form-control" placeholder="Description" id="get_comments" name="comments" style="height: 100px">{{ $book->comments }}</textarea>
