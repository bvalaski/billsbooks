...
class LWAuthors extends Component
{
    ...
    public function render()
    {
        ...
        $book_list = Book::where('author_id', '=', $this->authID)->when($this->authID > 1, function ($query) {
            return $query->orWhere('coauthor_id', '=', $this->authID);
        })->with('Series')->orderBy('published')->paginate(5);
