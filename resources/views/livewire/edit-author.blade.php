<div wire:ignore.self class="modal fade" @if($showeditAuthormodal) style="display:block" @endif id="editAuthorModal"
    tabindex="-1" aria-labelledby="editAuthorLabel" aria-hidden="true">
